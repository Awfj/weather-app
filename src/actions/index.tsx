...
export const SWITCH_TO_CELSIUS = "SWITCH_TO_CELSIUS";
export type SWITCH_TO_CELSIUS = typeof SWITCH_TO_CELSIUS;

export const SWITCH_TO_FAHRENHEIT = "SWITCH_TO_FAHRENHEIT";
export type SWITCH_TO_FAHRENHEIT = typeof SWITCH_TO_FAHRENHEIT;
